# Generated by Django 3.2 on 2023-11-23 13:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, help_text='name as it was returned by social media provider.', max_length=300, verbose_name='name')),
                ...
                ('user_type', models.CharField(choices=[('users', 'Users'), ('seller', 'Seller')], default='users', max_length=10)),
